...
# Generated on: Mon Jan 16 21:47:28 PST 2023 (Tue Jan 17 05:47:28 UTC 2023)
...
set logfile fv/simple_adder/rtl_to_fv_map.log
...
read_implementation_information fv/simple_adder -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/pkgs/cadence/2022-09/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/pkgs/cadence/2022-09/GENUS211/tools.lnx86"
set env(CW_DIR) "/pkgs/cadence/2022-09/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/pkgs/cadence/2022-09/GENUS211/tools.lnx86/lib/chipware"
...
read_library -liberty -both \
    /pkgs/synopsys/2020/32_28nm/SAED32_EDK/lib/stdcell_rvt/db_nldm/saed32rvt_ss0p95v125c.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/simple_adder.sv
elaborate_design -golden -root {simple_adder} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/simple_adder/fv_map.v.gz
elaborate_design -revised -root {simple_adder}
...
#add_name_alias fv/simple_adder/fv_map.singlebit.original_name.alias.json.gz -revised
